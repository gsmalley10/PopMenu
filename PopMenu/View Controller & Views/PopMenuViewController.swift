...
extension PopMenuViewController {
    ...
    fileprivate func configureContentView() {
        ...
        containerView.addShadow(offset: .init(width: 0, height: 2), opacity: 0.15, radius: 4.0)
    ...
    fileprivate func calculateContentOrigin(with size: CGSize) -> CGPoint {
        ...
        if let customOffset = appearance.popMenuPresentationStyle.offset {
            ...
            let offsetY = sourceFrame.size.height + customOffset.y.magnitude
